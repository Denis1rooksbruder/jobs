...
TEAM_STHOUND = DarkRP.createJob("ST SGT HOUND", {
    ...
    weapons = {"rw_sw_shield_cg", "rw_sw_shield_rep", "rw_sw_shield_rep_dc17", "stunstick", "weapon_cuff_rope", "re_hands", "rw_sw_dc15a_o", "weapon_fists", "weapon_cuff_elastic", "swep_mexicanshockstaff", "arrest_stick", "unarrest_stick", "rw_sw_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_stun_dc15s"},
    command = "stsgthound",
    max = 5,
    salary = 100,
    admin = 0,
...
TEAM_STFOX = DarkRP.createJob("Commander Fox", {
    ...
    weapons = {"rw_sw_rps6", "rw_sw_shield_cg", "rw_sw_shield_rep", "rw_sw_shield_rep_dc17", "stunstick", "re_hands", "rw_sw_dc15a_o", "seal6-c4", "weapon_breachingcharge", "weapon_fists", "weapon_cuff_elastic", "swep_mexicanshockstaff", "arrest_stick", "unarrest_stick", "rw_sw_dual_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "weapon_cuff_elastic", "rw_sw_stun_dc15s"},
    command = "cmdfox",
    max = 1,
    salary = 100,
    admin = 0,
...
TEAM_STTHORN = DarkRP.createJob("Commander Thorn", {
    ...
    weapons = {"rw_sw_shield_cg", "rw_sw_shield_rep", "rw_sw_shield_rep_dc17", "rw_sw_z6", "stunstick", "re_hands", "rw_sw_dc15a_o", "seal6-c4", "weapon_breachingcharge", "weapon_fists", "weapon_cuff_elastic", "swep_mexicanshockstaff", "arrest_stick", "unarrest_stick", "rw_sw_dual_dc17", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "weapon_cuff_elastic", "rw_sw_stun_dc15s"},
    command = "cmdthorn",
    max = 1,
    salary = 100,
    admin = 0,
...
TEAM_CPLRYS = DarkRP.createJob("ST CPL Rys", {
    ...
    weapons = {"rw_sw_rps6", "rw_sw_stun_dc15s", "rw_sw_shield_rep_dc17", "keys", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_stun_dc17", "rw_sw_shield_rep", "weapon_cuff_elastic", "re_hands"},
    command = "rys",
    max = 0,
    salary = 100,
    admin = 0,
