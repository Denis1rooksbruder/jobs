...
TEAM_KIX = DarkRP.createJob("TC MED SGT Kix", {
    ...
    weapons = {"med_kit" , "rw_sw_nade_bacta" , "rw_sw_stun_dc15s" , "sw_datapad", "weapon_fists", "re_hands", "cross_arms_infront_swep", "cross_arms_swep", "salute_swep", "rw_sw_dc15s", "rw_sw_dc15a_o", "rw_sw_dc17", "tfa_defi_swrp", "weapon_bactainjector", "zbl_gun", "zbl_spray"},
    command = "kix",
    max = 1,
    salary = 50,
    admin = 0,
